...
%% TODO temperatura zapłonu powinna być kursywą
...
%% TODO fix this when you'll be at least partially awake...
\begin{itemize}
...
%% TODO FIXME Jak się znajdzie jakaś inna przystępna definicja to podmienić
...
Przyjmuje się, że radiacja zachodzi dla ciał o temperaturach wyższych od $0$ K. %%???? <--- FIXME verify
Promieniowanie jest rodzajem wymiany energii, która nie wymaga żadnego nośnika. Każde ciało emituje fale.
%% FIXME Nnnnnnggggaaaaaa!! It is not enough for *happy days* I am sure.
